...
win.setGeometry(500,200,300,350)

win.setStyleSheet("background-color: white;")
win.setStyleSheet("color: red; font-size: 20px;")
...
def btn9():
    txt_1.setText(txt_1.text()+"9")
def btn8():
    txt_1.setText(txt_1.text()+"8")
def btn7():
    txt_1.setText(txt_1.text()+"7")
def btn6():
    txt_1.setText(txt_1.text()+"6")
def btn5():
    txt_1.setText(txt_1.text()+"5")
def btn4():
    txt_1.setText(txt_1.text()+"4")
def btn3():
    txt_1.setText(txt_1.text()+"3")
def btn2():
    txt_1.setText(txt_1.text()+"2")
def btn1():
    txt_1.setText(txt_1.text()+"1")
def btn0():
    txt_1.setText(txt_1.text()+"0")
def btna():
    txt_1.setText(txt_1.text()[:-1])

islemler = []
def btnb():
    islemler.append(txt_1.text())
    islemler.append(btn_b.text())
    txt_1.clear()
    # islemler.append("+")
    print(islemler)
...
def btnd():
    islemler.append(txt_1.text())
    islemler.append(btn_d.text())
    txt_1.clear()
    # islemler.append("+")
    print(islemler)
def btne():
    islemler.append(txt_1.text())
    sonuc = float(islemler[0])

    for i,j in enumerate(islemler):
        if j == " + ":
            sonuc += float(islemler[i+1])
        elif j == " - ":
            sonuc -= float(islemler[i + 1])
        elif j == " / ":
            sonuc /= float(islemler[i + 1])
    ...
    txt_1.setText(str(sonuc))
    print(islemler)

def btnf():
    islemler.append(txt_1.text())
    islemler.append(btn_f.text())
    txt_1.clear()
    # islemler.append("+")
    print(islemler)

btn_9.clicked.connect(btn9)
btn_8.clicked.connect(btn8)
btn_7.clicked.connect(btn7)
btn_6.clicked.connect(btn6)
btn_5.clicked.connect(btn5)
btn_4.clicked.connect(btn4)
btn_3.clicked.connect(btn3)
btn_2.clicked.connect(btn2)
btn_1.clicked.connect(btn1)
btn_0.clicked.connect(btn0)
btn_a.clicked.connect(btna)

btn_b.clicked.connect(btnb)
btn_c.clicked.connect(btnc)
btn_d.clicked.connect(btnd)
btn_e.clicked.connect(btne)
btn_f.clicked.connect(btnf)
